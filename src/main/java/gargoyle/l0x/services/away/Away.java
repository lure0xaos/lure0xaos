...
import static gargoyle.l0x.services.away.AwayConstants.PATTERN;
...
public interface Away {
    ...
    default String rewriteText(String text) {
        return replaceAll(text, PATTERN, matcher -> rewrite(matcher.group(0)));
    }

    default String rewriteHtml(String text) {
        return replaceAll(text, PATTERN, matcher ->
        {
