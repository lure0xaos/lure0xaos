...
public abstract class BaseEntityService<ID, E extends IdEntity<ID>, R extends IdEntityRepository<E, ID>> {
    ...
    public BaseEntityService(Class<E> entityType, R repository) {
    ...
    protected final List<E> getAllSorted() {
        ...
        return defaultSort == null ? repository.findAll() : findAll(defaultSort);
    }
    ...
    protected final List<E> findAll(Sort sort) {
        return repository.findAll(sort == null ? getDefaultSort() : sort);
    }
    ...
    @Transactional
    protected Optional<E> transform(Predicate<? super E> validation, Function<? super E, ? extends E> operation, ID id) {
