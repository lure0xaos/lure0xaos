...
@Controller
@RequestMapping(WebSecurityConfig.PATH_ADMIN + AdminSessionsController.PATH_SESSIONS)
@RequiredArgsConstructor
public class AdminSessionsController {
    public static final String PATH_SESSIONS = "/sessions";
    public static final String VIEW_ADMIN_SESSIONS = "admin/sessions";
